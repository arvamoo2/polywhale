          ...
          >
            ...
            <div style={{ padding: "32px 30px", background: "rgba(6,10,24,0.6)" }}>
              ...
              <div style={{ marginBottom: 36 }}>
                ...
                <div
                  ...
                  onClick={(e) => {
                    ...
                    setPosSize(Math.round((pct * 5000) / 50) * 50);
                  }}
                >
                  <div style={{
                    position: "absolute", top: 0, left: 0, height: "100%",
                    width: `${(posSize / 5000) * 100}%`, borderRadius: 3,
                  ...
                  <div style={{
                    ...
                    left: `calc(${(posSize / 5000) * 100}% - 9px)`,
                    width: 18, height: 18, borderRadius: "50%",
                    background: COLORS.accent, border: "3px solid #060b18",
                    boxShadow: "0 0 12px rgba(0,229,204,0.5)",
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                {Object.entries(categories).map(([cat, active]) => (
                  <button
                    key={cat}
                    onClick={() => toggleCat(cat)}
                    style={{
                      padding: "14px 16px", borderRadius: 12,
                      border: `1px solid ${active ? "rgba(0,229,204,0.2)" : "rgba(255,255,255,0.04)"}`,
                      background: active ? "rgba(0,229,204,0.06)" : "rgba(255,255,255,0.01)",
                  ...
                  >
                    <div style={{
                      ...
                      boxShadow: active ? `0 0 8px ${COLORS.accent}50` : "none",
                      transition: "all 0.2s",
                    }} />
                    {cat}
                  </button>
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        border: `1px solid ${active ? `${rp.color}30` : "rgba(255,255,255,0.03)"}`,
                        background: active ? `${rp.color}08` : "rgba(255,255,255,0.01)",
                      ...
                      <div style={{
                        ...
                        {active && (
                          <div style={{
                            ...
                            background: rp.color,
                            boxShadow: `0 0 10px ${rp.color}60`,
                          }} />
                        )}
                      </div>
                      <div style={{ textAlign: "left" }}>
                        <div style={{ fontSize: 14, fontWeight: 700, color: active ? "#fff" : COLORS.textSecondary, marginBottom: 2 }}>
                          {rp.label}
                        </div>
                        <div style={{ fontSize: 11, color: active ? rp.color : "rgba(255,255,255,0.18)" }}>
                          {rp.desc}
                        </div>
                      </div>
                    </button>
